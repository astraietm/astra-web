        ...
        events_to_sync = [
            {
                ...
                "is_team_event": True,
                "event_date": timezone.make_aware(datetime(2026, 2, 12, 10, 0)),
            ...
            },
            {
                ...
                "is_team_event": False,
                "event_date": timezone.make_aware(datetime(2026, 2, 11, 11, 0)),
                "time": "11:00 AM",
            ...
            },
            {
                ...
                "is_team_event": True,
                "event_date": timezone.make_aware(datetime(2026, 2, 12, 15, 0)),
                "time": "03:00 PM",
                "duration": "1 Hour 30 Mins",
                "prize": "₹500",
                "content_blocks": [],
            ...
            },
            {
                ...
                "is_team_event": False,
                "event_date": timezone.make_aware(datetime(2026, 2, 12, 13, 30)),
                "time": "01:30 PM",
                "duration": "2 Hours",
                "prize": "₹200",
                "content_blocks": [],
            ...
            },
            {
                ...
                "is_team_event": False,
                "event_date": timezone.make_aware(datetime(2026, 2, 10, 14, 0)),
                "time": "online",
                "duration": "nil",
                "prize": "₹200",
                "content_blocks": [],
            ...
            },
            {
                ...
                "is_team_event": False,
                "event_date": timezone.make_aware(datetime(2026, 2, 11, 12, 30)),
                "time": "12:30 PM",
                "duration": "nil",
                "prize": "₹0",
                "content_blocks": [],
