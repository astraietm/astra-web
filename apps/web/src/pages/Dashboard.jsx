...
const Dashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-[#020202] text-white selection:bg-blue-500/30 overflow-x-hidden font-outfit pt-32 pb-32 relative">
             
             {/* --- BACKGROUND SCENE (Events Section Match) --- */}
