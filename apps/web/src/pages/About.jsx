                                    ...
                                    <div className="group relative w-full h-full bg-[#050505] border border-white/5 transition-all duration-300 hover:border-primary/50">
                                        ...
                                        <div className="relative p-8 flex flex-col items-center text-center h-full">
                                            ...
                                            <div className="relative mb-6">
                                                {member.github ? (
                                                    <a href={member.github} target="_blank" rel="noopener noreferrer" className="relative z-10 block cursor-pointer">
                                                        <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-white/5 group-hover:border-primary/50 transition-colors bg-gray-900 group-hover:shadow-[0_0_15px_rgba(0,255,65,0.3)]">
                                                            <img
                                                ...
                                                {/* Dashed Ring */}
                                                <div className="absolute top-[-8px] left-[-8px] right-[-8px] bottom-[-8px] border border-dashed border-white/20 rounded-full animate-[spin_12s_linear_infinite] group-hover:border-primary/40 pointer-events-none"></div>
                                                <div className="absolute top-[-8px] left-[-8px] right-[-8px] bottom-[-8px] border border-dashed border-white/10 rounded-full animate-[spin_12s_linear_infinite_reverse] scale-110 pointer-events-none"></div>
                                            </div>
