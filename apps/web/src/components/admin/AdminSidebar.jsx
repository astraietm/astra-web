    ...
    return (
        <>
            ...
            <AnimatePresence>
                {isMobileOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 bg-slate-900/20 backdrop-blur-sm z-[95] lg:hidden"
                    />
                )}
            </AnimatePresence>
            ...
            <motion.aside
                ...
                className={`fixed left-0 top-0 h-screen bg-white border-r border-slate-200 z-[100] transition-all duration-300 flex flex-col
            ...
            >
                ...
                <div className="h-16 flex items-center px-5 border-b border-slate-200 shrink-0">
                    ...
                    >
                        <div className="w-9 h-9 rounded-lg bg-blue-600 flex items-center justify-center text-white shrink-0 group-hover:bg-blue-700 transition-colors">
                ...
                <div className="p-3 border-t border-slate-200">
                    <button
                        ...
                        className={`w-full flex items-center gap-3 p-2.5 rounded-lg hover:bg-slate-50 transition-all duration-150 group ${isCollapsed ? 'justify-center' : ''}`}
                    >
                        <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 shrink-0 font-semibold text-sm">
                            {user?.avatar ? (
                        ...
                        {!isCollapsed && (
                            <>
                                <div className="flex-1 text-left overflow-hidden">
                                    <p className="text-[13px] font-medium text-slate-900 truncate leading-tight">{user?.name || 'Admin'}</p>
