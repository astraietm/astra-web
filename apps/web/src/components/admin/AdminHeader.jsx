            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-border">
                    <div className="relative group">
                        <button className="w-9 h-9 rounded-lg overflow-hidden border border-white/10 flex items-center justify-center bg-gradient-primary text-white hover:opacity-90 transition-opacity">
                            {user?.avatar ? (
                                <img 
                                    src={user.avatar} 
                                    alt={user.name || "User"} 
