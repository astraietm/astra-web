            ...
            <div className="flex items-center gap-10 relative z-10">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[9px] font-black text-blue-400 uppercase tracking-[0.6em] leading-none">Sector_ID</span>
                    </div>
                ...
                <div className="hidden xl:flex items-center gap-4 group cursor-default">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[8px] font-black text-slate-500 uppercase tracking-[0.2em] mt-0.5">Primary_Hub_01</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center gap-10 relative z-10">
                ...
                <div className="relative hidden lg:block group">
                    ...
                    <input
                        ...
                        readOnly
                        className="bg-white/[0.01] border border-white/[0.05] rounded-[1.25rem] h-12 pl-12 pr-28 text-[9px] font-black w-80 transition-all focus:outline-none focus:bg-white/[0.03] placeholder:text-slate-600 hover:bg-white/[0.02] hover:border-white/[0.08] cursor-pointer text-slate-400 uppercase tracking-[0.3em]"
                    />
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center bg-white/[0.02] border border-white/[0.05] rounded-[1.25rem] p-1.5 gap-1.5">
                        <button className="w-10 h-10 rounded-xl flex items-center justify-center text-slate-500 hover:text-blue-500 hover:bg-blue-500/5 transition-all relative group/btn">
                        ...
                        <button className="w-10 h-10 rounded-xl flex items-center justify-center text-slate-500 hover:text-white hover:bg-white/[0.05] transition-all group/btn">
                    ...
                    <button className="flex items-center gap-4 pl-1.5 pr-6 py-1.5 rounded-[1.25rem] bg-white/[0.02] border border-white/[0.05] hover:border-blue-500/20 hover:bg-white/[0.04] transition-all group">
                        ...
                        <div className="hidden md:block text-left">
                            ...
                            <p className="text-[8px] font-black text-slate-500 uppercase tracking-[0.2em] leading-none">Clearance_Level_A</p>
                        </div>
                    </button>
                </div>
            </div>
