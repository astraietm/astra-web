                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 mb-16">
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <div className="flex gap-4">
                            {[
                                { Icon: Mail, href: "mailto:astra@ietm.in", label: "Email" },
                                ...
                                <a
                                    ...
                                    aria-label={label}
                                    className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center text-neutral-400 hover:bg-white/10 hover:text-white hover:border-white/20 transition-all duration-300"
                                >
