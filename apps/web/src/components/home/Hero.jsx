...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-primary/20 blur-[80px] sm:blur-[100px] rounded-full mix-blend-screen opacity-60 pointer-events-none z-10 animate-pulse [animation-duration:4000ms]" />
            ...
            <div className="absolute inset-0 pointer-events-none z-10 opacity-30">
                <div className="absolute top-1/4 left-1/4 w-1 h-1 bg-white rounded-full animate-ping [animation-duration:3000ms]" />
                <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-primary rounded-full animate-ping [animation-duration:4000ms] delay-1000" />
