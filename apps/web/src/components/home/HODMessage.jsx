        ...
        <section className="py-20 relative overflow-hidden">
             <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-6xl mx-auto mb-16 md:mb-32 px-4 md:px-0">
                    <FadeInUp delay={0.4}>
                        <div className="flex flex-col lg:grid lg:grid-cols-[400px_1fr] gap-12 md:gap-20 items-center">
                            
                            {/* Left: Image & Badge */}
                            <div className="relative flex flex-col items-center lg:self-start lg:sticky lg:top-32 order-1 lg:order-1">
                                ...
                                <div className="mt-8 text-center">
                                    <h4 className="text-white font-display font-bold text-xl md:text-xl tracking-normal whitespace-nowrap uppercase">
                                        Asst Prof. Thara Krishnan R
                                    </h4>
                                    <div className="h-1 w-8 md:w-12 bg-primary mx-auto my-3 rounded-full"></div>
                                    <p className="text-gray-400 font-mono text-xs md:text-xs uppercase tracking-[0.2em]">
                                        Head of Department
                                    </p>
                                </div>
                            </div>
                            ...
                            {/* Right: Content */}
                            <div className="text-left w-full order-2 lg:order-2">
                                <h2 className="text-3xl md:text-5xl font-display font-serif text-white mb-6 md:mb-8 block text-center lg:text-left">
                                    Message from <span className="text-primary italic">HOD</span>
                                </h2>
                                
                                <p className="text-gray-300 text-base md:text-lg leading-relaxed font-light font-sans text-center lg:text-left px-2 sm:px-0">
