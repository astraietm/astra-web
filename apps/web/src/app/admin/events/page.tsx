      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#C3FF16] text-black font-pixel text-[10px] uppercase tracking-wider border-2 border-black hover:translate-x-0.5 hover:translate-y-0.5 transition-all"
          >
