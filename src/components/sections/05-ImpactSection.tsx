    ...
    <section id="impact" className="relative overflow-hidden">
      ...
      >
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-12 relative z-10">
          ...
          <PaperCard size="lg" className="text-center shadow-[8px_8px_0px_#000] border-2 border-black">
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6, ease: [0.23, 1, 0.32, 1] }}
              className="font-display font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-black leading-snug tracking-tight uppercase"
            >
              WE ARE BUILDING A FORCE OF{' '}
              <span className="font-pixel text-3xl sm:text-4xl md:text-5xl lg:text-6xl inline-block align-middle mx-1 text-black font-extrabold">
