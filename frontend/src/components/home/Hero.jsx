...
const Hero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden bg-background pt-32 pb-20 md:py-0"
    >
      ...
      >
        ...
        <ScrollReveal variant="up" delay={0.2}>
            <div className="inline-flex items-center gap-2 px-2.5 py-1 md:px-3 md:py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-6 md:mb-8">
                <span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
                <span className="text-[10px] md:text-xs font-mono font-medium text-gray-300 tracking-wider uppercase">Official Cyber Association</span>
            </div>
        </ScrollReveal>
