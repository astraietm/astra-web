        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {events.map((event, index) => (
                <FadeInUp key={event.id} delay={index * 0.1}>
                    <div
                        className="group bg-white/5 border border-white/10 p-5 md:p-8 rounded-2xl hover:bg-white/10 hover:border-white/20 transition-all duration-300 relative overflow-hidden h-full"
                    >
                        ...
                        <h3 className="text-lg md:text-xl font-display font-medium text-white mb-3 group-hover:text-primary transition-colors">
                            {event.title}
                        </h3>
